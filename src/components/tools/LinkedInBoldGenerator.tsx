      ...
      <div className="grid grid-cols-1 items-start gap-6 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
        <section className="flex flex-col gap-4 rounded-[2rem] border border-black/[0.05] bg-white p-5 shadow-[0_20px_50px_-20px_rgba(28,26,23,0.14)] md:p-7">
          ...
          <textarea
            ...
            rows={12}
            className="mondy-scrollbar w-full resize-y rounded-[1.5rem] border border-black/[0.06] bg-mondy-surface px-5 py-4 text-[16px] leading-relaxed tracking-tight text-mondy-ink outline-none placeholder:text-mondy-ink/30 focus:border-mondy-accent/50 focus:ring-2 focus:ring-mondy-accent/20"
          />
        </section>
