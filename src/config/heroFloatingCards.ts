...
export const mondyHeroFloatingCards = {
  ...
  presetWidths: {
    compact: "sm:w-[min(26vw,9rem)] md:w-[152px] lg:w-[180px] xl:w-[200px]",
    cozy: "sm:w-[min(30vw,11rem)] md:w-[180px] lg:w-[212px] xl:w-[240px]",
    comfortable: "sm:w-[min(33vw,12.5rem)] md:w-[200px] lg:w-[248px] xl:w-[280px]",
    large: "sm:w-[min(36vw,14rem)] md:w-[220px] lg:w-[280px] xl:w-[320px]",
  ...
  presetSizes: {
    ...
    large:
      "(min-width: 1280px) 320px, (min-width: 1024px) 280px, (min-width: 768px) 220px, (min-width: 640px) min(36vw, 14rem), 100vw",
  } as const satisfies Record<MondyHeroFloatingCardPreset, string>,
} as const;
