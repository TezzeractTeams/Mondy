...
export type { MondyHeroFloatingCardPreset } from "@/config/heroFloatingCards";
export { mondyHeroFloatingCards } from "@/config/heroFloatingCards";
...
export const mondyType = {
  ...
  sectionHeading: cn(
    "font-noah text-mondy-ink  text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-[-0.06em] leading-[1]",
  ),
  sectionLead: cn(
...
export const mondyHero = {
  floatingCards: mondyHeroFloatingCards,
